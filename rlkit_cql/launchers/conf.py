...
rlkit_project_dir = join(os.path.dirname(rlkit_cql.__file__), os.pardir)
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    ...
    # '/home/user/path/to/rlkit_cql/scripts/run_experiment_from_doodad.py'
)
"""
AWS Settings
"""
...
SSS_RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    '/global/home/users/USERNAME/path/to/rlkit_cql/scripts'
...
try:
    from rlkit_cql.launchers.conf_private import *
except ImportError:
