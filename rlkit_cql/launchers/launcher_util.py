...
from rlkit_cql.launchers import conf
from rlkit_cql.torch.pytorch_util import set_gpu_mode
import rlkit_cql.pythonplusplus as ppp
...
def run_experiment(
    ...
    :param use_gpu:
    :param snapshot_mode: See rlkit_cql.core.logging
    :param snapshot_gap: See rlkit_cql.core.logging
    ...
    if mode == 'local':
        ...
        dmode = doodad.mode.EC2AutoconfigDocker(
            ...
            # will start just making the sub-directories within rlkit_cql rather
